...
export const faqContent = {
  ...
  items: [
    ...
    {
      question: '"여기 줄 서기"는 어떻게 동작하나요?',
      answer:
        '오늘 점심에 갈 식당을 선택하는 투표입니다. IP당 하루 1회만 가능하며, 오늘 방문 예정 인원이 많은 순으로 식단표 카드가 정렬됩니다. 자정(한국 시간)에 초기화됩니다.',
    },
    {
...
export const featuresContent = {
  ...
  items: [
    ...
    },
    {
      title: '오늘 방문 예정 투표',
      description:
        '각 식당 식단표 아래 "여기 줄 서기" 버튼으로 오늘 방문 예정 인원을 표시합니다. IP당 하루 1회 투표 가능하며, 인원 순으로 식단표가 정렬됩니다.',
    },
    {
      title: '식단표 자동 갱신',
      description:
