export const siteMeta = {
  ...
  description:
    '부산 센텀시티 파티박스, 다와푸드 센텀점, 만나한식뷔페, 영상산업센터(STX F&C) 구내식당의 이번 주 식단표, 위치, 점심·저녁 가격을 한곳에서 확인하세요.',
  keywords:
...
export const aboutContent = {
  ...
  paragraphs: [
    ...
    '센텀시티에는 파티박스(동서대 센텀캠퍼스), 다와푸드 센텀점(에이스하이테크21), 만나한식뷔페(벽산e센텀클래스원), 영상산업센터 구내식당 STX F&C 등 가성비 좋은 한식 뷔페형 구내식당이 운영되고 있습니다. 각 식당마다 가격, 위치, 영업 시간, 주간 메뉴가 다르기 때문에 한 페이지에서 비교하는 것이 편리합니다.',
...
export const featuresContent = {
  ...
  items: [
    {
      title: '4곳 구내식당 한눈에 보기',
      description:
        '파티박스, 다와푸드 센텀점, 만나한식뷔페, 영상산업센터 구내식당의 이번 주 식단표를 식당별 카드 형태로 제공합니다.',
    },
    {
      title: '주간 식단표 자동 갱신',
      description:
        '매주 새로 올라오는 주간 식단표 이미지를 반영하여, 센텀시티 구내식당 메뉴 변동을 빠르게 확인할 수 있습니다.',
    },
    {
      title: '위치·가격·영업시간 안내',
      description:
