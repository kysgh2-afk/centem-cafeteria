...
export const disclaimerContent = {
  ...
  paragraphs: [
    ...
    '메뉴 이미지와 식단 데이터는 각 식당 네이버 블로그·카카오채널·건물 게시판 등 공개된 출처에서 수집합니다. 저작권은 원저작자에게 있으며, 문제가 있는 경우 운영자 이메일로 연락 주시면 신속히 조치하겠습니다.',
...
export const privacyContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: '게시글과 댓글은 이용자가 비밀번호로 삭제하거나 운영자가 운영 원칙에 따라 삭제할 때까지 보관됩니다. 삭제 시 작성 내용·표시 이름·비밀번호 해시를 제거합니다. 요청 제한용 접속 정보는 새 쓰기 요청 처리 시 24시간이 지난 기록을 정리하며, 신고 정보는 운영자가 처리 완료하면 제거합니다. 제3자 서비스가 처리하는 정보는 각 서비스 제공자의 정책을 따릅니다.',
    },
    {
      title: '6. 이용자의 권리',
